...
- CSS: Plain CSS used for styling (You can replace with Tailwind CSS or another CSS framework if desired).
  
**Usage**
- You can select options from the dropdowns in the table's first and second columns.
- The "Add Row" button allows adding new rows dynamically.
- In the second column, users can add new items to the list, which will immediately appear as options.
  
**Features to Consider for Enhancement**
- Data Persistence: Integrate local storage or a backend API to save table data for future sessions.
- Validation: Implement validation to ensure data integrity, such as preventing the same option selection across rows.
- Styling Improvements: Enhance UI design with animations or custom styles.
